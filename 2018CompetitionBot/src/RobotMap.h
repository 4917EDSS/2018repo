...
//CAN IDs
constexpr int LEFT1_DRIVE_MOTOR_CANID = 2;
constexpr int LEFT2_DRIVE_MOTOR_CANID = 4;
constexpr int LEFT3_DRIVE_MOTOR_CANID = 6;
constexpr int RIGHT1_DRIVE_MOTOR_CANID = 1;
constexpr int RIGHT2_DRIVE_MOTOR_CANID = 3;
constexpr int RIGHT3_DRIVE_MOTOR_CANID = 5;
constexpr int INTAKE_MOTOR_LEFT_CANID = 7;
constexpr int INTAKE_MOTOR_RIGHT_CANID = 12;
constexpr int ELEVATOR_MOTOR_CANID = 8;
constexpr int RAMP1_MOTOR_CANID = 9;
constexpr int RAMP2_MOTOR_CANID = 10;
constexpr int LIFT1_MOTOR_CANID = 11;
