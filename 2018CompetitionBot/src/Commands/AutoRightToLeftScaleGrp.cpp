...
AutoRightToLeftScaleGrp::AutoRightToLeftScaleGrp() {
	...
	AddSequential(new SilkyMotionCmd(std::vector<double>{-800,2700}, std::vector<double>{50, 100}));

	AddParallel(new MoveElevatorToHeightCmd(ElevatorSub::AUTO_FIRST_BOX_HEIGHT));
	AddSequential(new SilkyMotionCmd(std::vector<double>{-2700, 800}, std::vector<double>{-100, -50}));
