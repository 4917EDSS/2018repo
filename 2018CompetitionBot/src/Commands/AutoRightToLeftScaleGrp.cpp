...
AutoRightToLeftScaleGrp::AutoRightToLeftScaleGrp() {
	...
	AddSequential(new SilkyMotionCmd(std::vector<double> {4205, 2300, 3340, 1300}, std::vector<double> {0, -90, 0, 120}));
	...
	AddSequential(new SilkyMotionCmd(std::vector<double>{-1000,1450}, std::vector<double>{80, 47}));

	AddParallel(new MoveElevatorToHeightCmd(ElevatorSub::SCALE_BOX_HIGH_HEIGHT));

	AddSequential(new SilkyMotionCmd(std::vector<double>{-1450, 1000}, std::vector<double>{-47, -80}));
